...
func request_Resources_Submit_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.ResourcesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV1.SubmitRequest
	var metadata runtime.ServerMetadata
...
func local_request_Resources_Submit_0(ctx context.Context, marshaler runtime.Marshaler, server extV1.ResourcesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV1.SubmitRequest
	var metadata runtime.ServerMetadata
...
func request_Resources_Versions_0(ctx context.Context, marshaler runtime.Marshaler, client extV1.ResourcesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extV1.VersionsRequest
	var metadata runtime.ServerMetadata
...
func RegisterResourcesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extV1.ResourcesServer) error {
	...
	mux.Handle("POST", pattern_Resources_Submit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/controlplane.resources.v1.Resources/Submit", runtime.WithHTTPPathPattern("/v1/resources/create/async"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Resources_Submit_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Resources_Submit_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterResourcesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extV1.ResourcesClient) error {
	...
	mux.Handle("POST", pattern_Resources_Submit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/controlplane.resources.v1.Resources/Submit", runtime.WithHTTPPathPattern("/v1/resources/create/async"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Resources_Submit_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Resources_Submit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "resources", "create", "async"}, ""))
...
var (
	...
	forward_Resources_Submit_0 = runtime.ForwardResponseMessage
